...
echo "Your Masternode setup is in progress, please wait"
...
#Do some tasks
progress 20 "Running system checks"
#Do some tasks
checks
progress 40 "Preparing your Linux system"
#Do some tasks
prepare_system
progress 60 "Creating a swap file"
#Do some tasks
create_swap
progress 80 "Compiling masternode daemon..."
#Do some tasks
compile_node
